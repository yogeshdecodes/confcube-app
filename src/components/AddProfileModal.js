...
const AddProfileModal = ({ children, userName ,userBio , userSkills,  userLooking ,userInterests, saveState, userSave  }) => {
...
const toast = useToast();
  ...
  const onCreateSite = ({name, bio, mySkills , interests, lookingFor }) => {
    ...
    const user = getUser();
    const {uid} = user;
    const { id } = updatePublicUser(uid, name, bio, mySkills , interests, lookingFor);
